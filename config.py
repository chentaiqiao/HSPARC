...
def get_config():
    ...
    parser.add_argument("--edge_lr", type=float, default=1e-4,
                        help='edge learning rate (default: 1e-4)')
    ...
    parser.add_argument("--M_agent", type=int, default=10)
    parser.add_argument("--b_agent", type=int, default=5)
    parser.add_argument("--T_group", type=int, default=50)
    parser.add_argument("--alpha", type=float, default=0.6)
    parser.add_argument("--beta", type=float, default=1.0)
    parser.add_argument("--lambda", type=float, default=0.1)
    parser.add_argument("--lambda_tp", type=float, default=1.0)
