import torch
import numpy as np
from HSPARC.utils.util import update_linear_schedule
from HSPARC.utils.util import get_shape_from_obs_space, get_shape_from_act_space
from HSPARC.algorithms.utils.util import check
from HSPARC.algorithms.mat.algorithm.cformer import MAT_comm as MAT
...
class TransformerPolicy:
    ...
    # 修改 get_actions 接收 group_mask
    def get_actions(self, cent_obs, obs, rnn_states_actor, rnn_states_critic, masks, available_actions=None,
                    deterministic=False, scoring_network=None, group_mask=None): # Added group_mask
    ...
    # 修改 evaluate_actions 接收 group_mask 并返回 gate_logits
    def evaluate_actions(self, cent_obs, obs, rnn_states_actor, rnn_states_critic, actions, masks,
                         available_actions=None, active_masks=None, steps=0, total_step=0, group_mask=None): # Added group_mask
        ...
        # Pass group_mask to transformer.forward
        action_log_probs, values, entropy, gate_logits = self.transformer(cent_obs, obs, actions, available_actions, steps, total_step, group_mask=group_mask)
        ...
        return values, action_log_probs, entropy, gate_logits # Added gate_logits
