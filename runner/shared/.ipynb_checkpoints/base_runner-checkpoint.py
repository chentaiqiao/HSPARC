...
from HSPARC.utils.shared_buffer import SharedReplayBuffer
from HSPARC.algorithms.mat.mat_trainer import MATTrainer as TrainAlgo
from HSPARC.algorithms.mat.algorithm.transformer_policy import TransformerPolicy as Policy
...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        # algorithm
        self.trainer = TrainAlgo(self.all_args, self.policy, self.num_agents, device=self.device,envs_info=self.envs)
