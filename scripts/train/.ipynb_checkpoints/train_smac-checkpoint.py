...
from HSPARC.runner.shared.smac_runner import SMACRunner as Runner
...
def main(args):
    ...
    if all_args.env_name == "SMAC":
        ...
        from HSPARC.envs.starcraft2.smac_maps import get_map_params
        num_agents = get_map_params(all_args.map_name)["n_agents"]
